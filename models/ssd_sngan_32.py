...
class SSD_SNGANGenerator32(SSD_SNGANGenerator):
    r"""
    ResNet backbone generator for SNGAN.
...
class SSD_SNGANDiscriminator32(SSD_SNGANDiscriminator):
    r"""
    ResNet backbone discriminator for SNGAN.
    ...
    def forward(self, x):
        ...
        out_spectral = self.l5(fft_feature)
