"""
Implementation of SSD-SNGAN for image size 128.
"""
import torch
...
class SSD_SNGANGenerator128(SSD_SNGANGenerator):
    r"""
    ResNet backbone generator for SNGAN.
...
class SSD_SNGANDiscriminator128(SSD_SNGANDiscriminator):
    r"""
    ResNet backbone discriminator for SNGAN.
    ...
    def __init__(self, ndf=1024, **kwargs):
        ...
        self.l7 = SNLinear(88, 1)
        self.l8 = SNLinear(self.ndf, 1)
        self.activation = nn.ReLU(True)
    ...
    def forward(self, x):
        ...
        out_spectral = self.l7(fft_feature)
